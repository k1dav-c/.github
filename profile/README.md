...
| Repo | Description |
|------|-------------|
| [codertemplate](https://github.com/k1dav-c/codertemplate) | Coder workspace Terraform templates (devcontainer, Jupyter, PVE, GitHub runner) |
| [ai-development-tools](https://github.com/k1dav-c/ai-development-tools) | APMIC DevVault — internal dev platform for managing Coder workspace configs, DBs, and NAS |
| [nix-dotfile](https://github.com/k1dav-c/nix-dotfile) | Modular shell scripts for bootstrapping Coder dev environments (Zsh, Git, Claude Code) |
...
| Repo | Description |
|------|-------------|
| [rd-mcp-github-app](https://github.com/k1dav-c/rd-mcp-github-app) | AI-driven GitHub App actions: Issue/PR comments, code review, reactions |
...
| [pokemon-mcp](https://github.com/k1dav-c/pokemon-mcp) | Traditional Chinese Pokemon data (info, moves, abilities) via FastMCP |
...
| Repo | Description |
|------|-------------|
| [discord-daily-summary](https://github.com/k1dav-c/discord-daily-summary) | Message sync to PostgreSQL with browsing UI, Auth0, Discord OAuth2 |
...
| [discord-sync-consumer](https://github.com/k1dav-c/discord-sync-consumer) | Chat exporter — FastAPI REST API (JSON, HTML, CSV) |
...
| Repo | Description |
|------|-------------|
| [lufixapi](https://github.com/k1dav-c/lufixapi) | Backend — FastAPI + Hasura + Ory Hydra OIDC |
| [lufixdeploy](https://github.com/k1dav-c/lufixdeploy) | Docker Compose deployment |
| [lufixpage](https://github.com/k1dav-c/lufixpage) | Frontend — Quasar/Vue |
...
| Repo | Description |
|------|-------------|
| [rd-jira-tech-board-generator](https://github.com/k1dav-c/rd-jira-tech-board-generator) | AI-powered Jira Epic/Task generator — Next.js + LiteLLM |
